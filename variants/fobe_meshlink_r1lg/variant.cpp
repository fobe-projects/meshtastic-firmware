...
void initVariant()
{
    ...
    // Disable builtin LED
    pinMode(PIN_BUILTIN_LED, INPUT);

    // Disable builtin button
    pinMode(PIN_BUILTIN_BUTTON, INPUT);

    // Sensor
    pinMode(PIN_LSM6DS3TR_POWER, OUTPUT);
    digitalWrite(PIN_LSM6DS3TR_POWER, HIGH);
    pinMode(PIN_LSM6DS3TR_INT1, INPUT);
}
